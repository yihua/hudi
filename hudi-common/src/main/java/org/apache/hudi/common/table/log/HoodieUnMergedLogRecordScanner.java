...
public class HoodieUnMergedLogRecordScanner extends AbstractHoodieLogRecordReader {
  ...
  @Override
  public <T> void processNextRecord(HoodieRecord<T> hoodieRecord, Option<Integer> position) throws Exception {
  ...
  protected void processNextDeletePosition(int position) {
    throw new IllegalStateException("Not expected to see delete positions in this log-scan mode. Check Job Config");
  }
