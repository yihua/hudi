...
public class HoodieFileReaderFactory {
  ...
  public HoodieFileReader getFileReader(HoodieConfig hoodieConfig, Configuration conf, HoodieLocation path) throws IOException {
  ...
  public HoodieFileReader getFileReader(HoodieConfig hoodieConfig, Configuration conf, HoodieLocation path, HoodieFileFormat format)
      throws IOException {
  ...
  public HoodieFileReader getFileReader(HoodieConfig hoodieConfig,
                                        Configuration conf, HoodieLocation path, HoodieFileFormat format,
  ...
  protected HoodieFileReader newHFileFileReader(boolean useNativeHFileReader,
                                                Configuration conf, HoodieLocation path,
                                                Option<Schema> schemaOption) throws IOException {
    throw new UnsupportedOperationException();
  }

  protected HoodieFileReader newHFileFileReader(boolean useNativeHFileReader,
                                                Configuration conf, HoodieLocation location,
