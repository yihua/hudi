...
public class HoodieHBaseAvroHFileReader extends HoodieAvroHFileReaderImplBase {
  ...
  public HoodieHBaseAvroHFileReader(Configuration hadoopConf, HoodieLocation location, CacheConfig cacheConfig)
      throws IOException {
  ...
  public HoodieHBaseAvroHFileReader(HoodieLocation location, HoodieStorage storage, Configuration hadoopConf, CacheConfig config,
