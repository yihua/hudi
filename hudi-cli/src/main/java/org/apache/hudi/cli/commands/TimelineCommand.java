...
public class TimelineCommand implements CommandMarker {
  ...
  private String printTimelineInfo(
    ...
    TableHeader header = new TableHeader()
        ...
        .addTableHeaderField(HoodieTableHeaderField.HEADER_ACTION)
        .addTableHeaderField(HoodieTableHeaderField.HEADER_STATE);
    if (showRollbackInfo) {
      header.addTableHeaderField(HoodieTableHeaderField.HEADER_ROLLBACK_INFO);
    }
    header.addTableHeaderField(HoodieTableHeaderField.HEADER_REQUESTED_TIME)
        .addTableHeaderField(HoodieTableHeaderField.HEADER_INFLIGHT_TIME)
        .addTableHeaderField(HoodieTableHeaderField.HEADER_COMPLETED_TIME);
  ...
  private String printTimelineInfoWithMetadataTable(
    ...
    header.addTableHeaderField(HoodieTableHeaderField.HEADER_REQUESTED_TIME)
        .addTableHeaderField(HoodieTableHeaderField.HEADER_INFLIGHT_TIME)
        .addTableHeaderField(HoodieTableHeaderField.HEADER_COMPLETED_TIME)
        .addTableHeaderField(HoodieTableHeaderField.HEADER_MT_ACTION)
        .addTableHeaderField(HoodieTableHeaderField.HEADER_MT_STATE)
        .addTableHeaderField(HoodieTableHeaderField.HEADER_MT_REQUESTED_TIME)
        .addTableHeaderField(HoodieTableHeaderField.HEADER_MT_INFLIGHT_TIME)
        .addTableHeaderField(HoodieTableHeaderField.HEADER_MT_COMPLETED_TIME);
    return HoodiePrintHelper.print(
        header, new HashMap<>(), withRowNo, sortByField, descending, limit, headerOnly, rows);
  }
