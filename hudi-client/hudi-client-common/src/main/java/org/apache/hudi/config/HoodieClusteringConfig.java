...
public class HoodieClusteringConfig extends HoodieConfig {
  ...
  public static final String SPARK_RECENT_DAYS_CLUSTERING_PLAN_STRATEGY =
   ...
   */
  @Deprecated
  public static final String DEFAULT_CLUSTERING_PLAN_STRATEGY_CLASS = SPARK_RECENT_DAYS_CLUSTERING_PLAN_STRATEGY;
  /**
  ...
  public static class Builder {
    ...
    private String getDefaultPlanStrategyClassName(EngineType engineType) {
      switch (engineType) {
        case SPARK:
          return SPARK_RECENT_DAYS_CLUSTERING_PLAN_STRATEGY;
        case FLINK:
        case JAVA:
