...
public class HoodieTableSource extends FileIndexReader implements
  ...
  private HoodieSource<RowData> createHoodieSource() {
    ...
    boolean emitCommitTimeWatermark = conf.get(FlinkOptions.READ_COMMIT_TIME_WATERMARK_ENABLED);
    ...
    return new HoodieSource<>(context, splitReaderFunction, new HoodieSourceSplitComparator(), metaClient, new HoodieRecordEmitter<>(emitCommitTimeWatermark));
  }
