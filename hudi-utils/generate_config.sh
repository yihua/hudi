...
"$HOME/.m2/repository/org/apache/hudi/hudi-spark-bundle_2.11/$VERSION/hudi-spark-bundle_2.11-$VERSION.jar"
"$HOME/.m2/repository/org/apache/hudi/hudi-flink1.16-bundle/$VERSION/hudi-flink1.16-bundle-$VERSION.jar"
